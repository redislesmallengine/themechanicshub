...
export async function OpenWorkOrdersTable({ organizationId, agingDays }: { organizationId: string; agingDays: number }) {
  const [workOrders, total] = await Promise.all([getOpenWorkOrders(organizationId, 15), getOpenWorkOrderCount(organizationId)]);
  const now = getNow();
    ...
    <div className="dt-container">
      ...
      {total > 15 && (
        <div className="dt-footer">
          <span>Showing 15 of {total} open work orders</span>
